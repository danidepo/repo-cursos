...
#Index by position filas, columnas
data[1:5,8:9]
data[1:5,c(8,9)]
...
data[data$mpg>30]  ## error porque le falta la coma después de la condición en filas

## Excluir columnas
data[1:5, c(-1,-9)]
data[1:5, -c(1,9)]
data[1:5, -c("No", "car_name")] ## No se puede hacer
