...
#Funcion que se utiliza para crear aleatoriamente un muestreo desde 1 hasta el numero de divisiones, subconjuntos
...
#Resultado iteraciones con su error cuadratico
res <- loocv.reg(bh)
res
